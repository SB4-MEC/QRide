...
SECRET_KEY = 'django-insecure-(tx#wzyc+0num74d@qr)pbs#r3avs+@$pz9y##=_-$_u6vqrpa'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'temp_frontend')], #frontend test
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'qrbus8991@gmail.com'
EMAIL_HOST_PASSWORD = 'krnngrrkhwxorzcg'
EMAIL_USE_TLS = True
...
# https://docs.djangoprojecthttps://github.com/SB4-MEC/QRide.com/en/4.2/howto/static-files/
